...
function random_array(t){var a=Math.floor(Math.random()*t.length+t.length),r=t[a-t.length];return r}$(document).ready(function(){function t(){var t=["I go by the<br/>name <strong>Luc</strong>",'I push code <br/>to <a href="https://github.com/lbronsdijk" target="_blank" alt="Spotify">GitHub</a>','I do love <br/><a href="http://www.flickr.com/photos/lbronsdijk/sets/72157629787097051/" target="_blank">photography</a>','I tweet on<br/><a href="https://twitter.com/lbronsdijk" target="_blank">Twitter</a>','I am developer<br/> at <a href="http://www.angrybytes.nl/" target="_blank">Angry Bytes</a>','I drop photos on <br/><a href="http://instagram.com/lbronsdijk" target="_blank" alt="Instagram">Instagram</a>','I am good friends<br/>with <a href="http://www.apple.com/" target="_blank" alt="Apple">Apple</a>','I drink<br/><a href="http://en.starbucks.nl/" target="_blank" alt="Starbucks">Starbucks</a> coffee','I listen to the <br/>radiostation <a href="http://3fm.nl/" target="_blank" alt="3FM">3FM</a>','I stream music <br/>from <a href="http://open.spotify.com/user/lbronsdijk" target="_blank" alt="Spotify">Spotify</a>'];$("header").randomText(t,5e3)}t()}),$.fn.randomText=function(t,a,r){var e=$(this);0===$(".quotes").length&&e.append('<h1 class="quotes animated bounceInDown">');var n=$(".quotes");n.fadeOut(0,function(){for(var a=random_array(t);a==r;)a=random_array(t);n.empty().html(a),n.fadeIn(0),sendText=a}),timeOut=setTimeout(function(){e.randomText(t,a,sendText)},a)};